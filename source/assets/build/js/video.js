...
var request = fetch('assets/build/videos.json').then(/*#__PURE__*/function () {
...
play_btn.addEventListener('click', function (evt) {
  play_btn.classList.add('d-none');
  video.play();
});
var like_state = 0;
...
like_btn.addEventListener('click', function (evt) {
...
dislike_btn.addEventListener('click', function (evt) {
  if (dislike_btn.classList.contains('btn-warning')) {
    dislike_btn.classList.remove('btn-warning');
    dislike_btn.classList.add('btn-outline-warning');
    dislike_counter.innerHTML = parseInt(dislike_counter.innerHTML) - 1;
...
var fav_btn = document.querySelector('.fav-btn');
fav_btn.addEventListener('click', function (evt) {
...
submit_comment_btn.addEventListener('click', function (evt) {
